...
function App() {
    ...
    const getUniswapTokens = async () => {
        const response = await fetch('https://api.covalenthq.com/v1/1/xy=k/uniswap_v2/tokens/?quote-currency=USD&format=JSON&page-number=1&page-size=10&key=ckey_c9ceec82b70743a0b334b50ec49');
